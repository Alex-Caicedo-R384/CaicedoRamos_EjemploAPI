...
public partial class ClimaActual : ContentPage
{
    ...
    private async void Button_Clicked(object sender, EventArgs e)
    {
        ...
        {
            await DisplayAlert("Advertencia", "Por favor, ingrese valores válidos para Latitud y Longitud.", "OK");
            return;
        }
        ...
        {
            await DisplayAlert("Advertencia", "Se requiere conexión a Internet para consultar el clima.", "OK");
        }
    }
}